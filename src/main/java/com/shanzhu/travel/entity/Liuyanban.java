...
public class Liuyanban implements Serializable {
    ...
    @Column(name = "liuyantupian")
    private String liuyantupian;
    @Column(name = "liuyaneva")
    private String liuyaneva;
    ...
    public String getLiuyantupian() {
        return liuyantupian;
    }

    public void setLiuyantupian(String liuyantupian) {
        this.liuyantupian = liuyantupian == null ? "" : liuyantupian.trim();
    }

    public String getLiuyaneva() {
        return liuyaneva;
    }

    public void setLiuyaneva(String liuyaneva) {
        this.liuyaneva = liuyaneva == null ? "" : liuyaneva.trim();
    }
}
